...
I have added UI, buttons and event listeners*/
  ...
  public Anilamp(String textForTitleBar) {
    ...
    heliUp.addActionListener(new ActionListener() {
      ...
      public void actionPerformed(ActionEvent e) {
        Anilamp_GLEventListener.spinning(true);
      }
    });
    ...
    heliDown.addActionListener(new ActionListener() {
      ...
      @Override
      public void actionPerformed(ActionEvent e) {
        Anilamp_GLEventListener.spinning(false);
    ...
    light1On.addActionListener(new ActionListener() {
      ...
      @Override
      public void actionPerformed(ActionEvent e) {
          Anilamp_GLEventListener.light1On();
      }
    });
    ...
    light1Off.addActionListener(new ActionListener() {
      ...
      @Override
      public void actionPerformed(ActionEvent e) {
          Anilamp_GLEventListener.light1Off();
      }
    });
    ...
    light2On.addActionListener(new ActionListener() {
      ...
      @Override
      public void actionPerformed(ActionEvent e) {
          Anilamp_GLEventListener.light2On();
      }
    });
    ...
    light2Off.addActionListener(new ActionListener() {
      ...
      @Override
      public void actionPerformed(ActionEvent e) {
          Anilamp_GLEventListener.light2Off();
      }
    });
